...
module soc_system_mm_interconnect_0 (
	...
	wire  [116:0] msgdma_0_csr_agent_rf_source_data;                             // msgdma_0_csr_agent:rf_source_data -> msgdma_0_csr_agent_rsp_fifo:in_data
	...
	wire  [116:0] msgdma_0_csr_agent_rsp_fifo_out_data;                          // msgdma_0_csr_agent_rsp_fifo:out_data -> msgdma_0_csr_agent:rf_sink_data
	...
	wire   [20:0] msgdma_1_csr_agent_m0_address;                                 // msgdma_1_csr_agent:m0_address -> msgdma_1_csr_translator:uav_address
	...
	wire  [116:0] msgdma_1_csr_agent_rf_source_data;                             // msgdma_1_csr_agent:rf_source_data -> msgdma_1_csr_agent_rsp_fifo:in_data
	...
	wire  [116:0] msgdma_1_csr_agent_rsp_fifo_out_data;                          // msgdma_1_csr_agent_rsp_fifo:out_data -> msgdma_1_csr_agent:rf_sink_data
	...
	wire  [224:0] msgdma_0_descriptor_slave_agent_rf_source_data;                // msgdma_0_descriptor_slave_agent:rf_source_data -> msgdma_0_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [224:0] msgdma_0_descriptor_slave_agent_rsp_fifo_out_data;             // msgdma_0_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_0_descriptor_slave_agent:rf_sink_data
	...
	wire   [20:0] msgdma_1_descriptor_slave_agent_m0_address;                    // msgdma_1_descriptor_slave_agent:m0_address -> msgdma_1_descriptor_slave_translator:uav_address
	...
	wire  [224:0] msgdma_1_descriptor_slave_agent_rf_source_data;                // msgdma_1_descriptor_slave_agent:rf_source_data -> msgdma_1_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [224:0] msgdma_1_descriptor_slave_agent_rsp_fifo_out_data;             // msgdma_1_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_1_descriptor_slave_agent:rf_sink_data
	...
	wire  [115:0] msgdma_0_csr_agent_rp_data;                                    // msgdma_0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] msgdma_1_csr_agent_rp_data;                                    // msgdma_1_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [223:0] msgdma_0_descriptor_slave_agent_rp_data;                       // msgdma_0_descriptor_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [223:0] msgdma_1_descriptor_slave_agent_rp_data;                       // msgdma_1_descriptor_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> msgdma_0_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                             // msgdma_0_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                           // cmd_mux:src_channel -> msgdma_0_csr_burst_adapter:sink0_channel
	...
	wire  [115:0] msgdma_0_csr_burst_adapter_source0_data;                       // msgdma_0_csr_burst_adapter:source0_data -> msgdma_0_csr_agent:cp_data
	wire          msgdma_0_csr_burst_adapter_source0_ready;                      // msgdma_0_csr_agent:cp_ready -> msgdma_0_csr_burst_adapter:source0_ready
	wire    [3:0] msgdma_0_csr_burst_adapter_source0_channel;                    // msgdma_0_csr_burst_adapter:source0_channel -> msgdma_0_csr_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                         // cmd_mux_001:src_valid -> msgdma_1_csr_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> msgdma_1_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                         // msgdma_1_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                       // cmd_mux_001:src_channel -> msgdma_1_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                 // cmd_mux_001:src_startofpacket -> msgdma_1_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                   // cmd_mux_001:src_endofpacket -> msgdma_1_csr_burst_adapter:sink0_endofpacket
	wire          msgdma_1_csr_burst_adapter_source0_valid;                      // msgdma_1_csr_burst_adapter:source0_valid -> msgdma_1_csr_agent:cp_valid
	wire  [115:0] msgdma_1_csr_burst_adapter_source0_data;                       // msgdma_1_csr_burst_adapter:source0_data -> msgdma_1_csr_agent:cp_data
	wire          msgdma_1_csr_burst_adapter_source0_ready;                      // msgdma_1_csr_agent:cp_ready -> msgdma_1_csr_burst_adapter:source0_ready
	wire    [3:0] msgdma_1_csr_burst_adapter_source0_channel;                    // msgdma_1_csr_burst_adapter:source0_channel -> msgdma_1_csr_agent:cp_channel
	...
	wire  [223:0] msgdma_0_descriptor_slave_burst_adapter_source0_data;          // msgdma_0_descriptor_slave_burst_adapter:source0_data -> msgdma_0_descriptor_slave_agent:cp_data
	...
	wire    [3:0] msgdma_0_descriptor_slave_burst_adapter_source0_channel;       // msgdma_0_descriptor_slave_burst_adapter:source0_channel -> msgdma_0_descriptor_slave_agent:cp_channel
	...
	wire  [223:0] msgdma_1_descriptor_slave_burst_adapter_source0_data;          // msgdma_1_descriptor_slave_burst_adapter:source0_data -> msgdma_1_descriptor_slave_agent:cp_data
	...
	wire    [3:0] msgdma_1_descriptor_slave_burst_adapter_source0_channel;       // msgdma_1_descriptor_slave_burst_adapter:source0_channel -> msgdma_1_descriptor_slave_agent:cp_channel
	...
	wire  [223:0] router_004_src_data;                                           // router_004:src_data -> msgdma_0_descriptor_slave_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                          // msgdma_0_descriptor_slave_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [3:0] router_004_src_channel;                                        // router_004:src_channel -> msgdma_0_descriptor_slave_rsp_width_adapter:in_channel
	...
	wire    [3:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_channel;       // msgdma_0_descriptor_slave_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire  [223:0] router_005_src_data;                                           // router_005:src_data -> msgdma_1_descriptor_slave_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                          // msgdma_1_descriptor_slave_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [3:0] router_005_src_channel;                                        // router_005:src_channel -> msgdma_1_descriptor_slave_rsp_width_adapter:in_channel
	...
	wire  [115:0] msgdma_1_descriptor_slave_rsp_width_adapter_src_data;          // msgdma_1_descriptor_slave_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire    [3:0] msgdma_1_descriptor_slave_rsp_width_adapter_src_channel;       // msgdma_1_descriptor_slave_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [3:0] cmd_mux_002_src_channel;                                       // cmd_mux_002:src_channel -> msgdma_0_descriptor_slave_cmd_width_adapter:in_channel
	...
	wire  [223:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_data;          // msgdma_0_descriptor_slave_cmd_width_adapter:out_data -> msgdma_0_descriptor_slave_burst_adapter:sink0_data
	...
	wire    [3:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_channel;       // msgdma_0_descriptor_slave_cmd_width_adapter:out_channel -> msgdma_0_descriptor_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                          // cmd_mux_003:src_data -> msgdma_1_descriptor_slave_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                         // msgdma_1_descriptor_slave_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                       // cmd_mux_003:src_channel -> msgdma_1_descriptor_slave_cmd_width_adapter:in_channel
	...
	wire  [223:0] msgdma_1_descriptor_slave_cmd_width_adapter_src_data;          // msgdma_1_descriptor_slave_cmd_width_adapter:out_data -> msgdma_1_descriptor_slave_burst_adapter:sink0_data
	...
	wire    [3:0] msgdma_1_descriptor_slave_cmd_width_adapter_src_channel;       // msgdma_1_descriptor_slave_cmd_width_adapter:out_channel -> msgdma_1_descriptor_slave_burst_adapter:sink0_channel
