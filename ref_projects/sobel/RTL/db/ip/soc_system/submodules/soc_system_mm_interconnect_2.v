...
module soc_system_mm_interconnect_2 (
		...
		input  wire         msgdma_1_reset_n_reset_bridge_in_reset_reset,                       //                       msgdma_1_reset_n_reset_bridge_in_reset.reset
		input  wire [31:0]  msgdma_1_mm_write_address,                                          //                                            msgdma_1_mm_write.address
		output wire         msgdma_1_mm_write_waitrequest,                                      //                                                             .waitrequest
		input  wire [3:0]   msgdma_1_mm_write_burstcount,                                       //                                                             .burstcount
		input  wire [31:0]  msgdma_1_mm_write_byteenable,                                       //                                                             .byteenable
		input  wire         msgdma_1_mm_write_write,                                            //                                                             .write
		input  wire [255:0] msgdma_1_mm_write_writedata,                                        //                                                             .writedata
	...
	wire  [255:0] msgdma_1_mm_write_translator_avalon_universal_master_0_readdata;      // msgdma_1_mm_write_agent:av_readdata -> msgdma_1_mm_write_translator:uav_readdata
	...
	wire   [31:0] msgdma_1_mm_write_translator_avalon_universal_master_0_byteenable;    // msgdma_1_mm_write_translator:uav_byteenable -> msgdma_1_mm_write_agent:av_byteenable
	...
	wire  [255:0] msgdma_1_mm_write_translator_avalon_universal_master_0_writedata;     // msgdma_1_mm_write_translator:uav_writedata -> msgdma_1_mm_write_agent:av_writedata
	wire    [8:0] msgdma_1_mm_write_translator_avalon_universal_master_0_burstcount;    // msgdma_1_mm_write_translator:uav_burstcount -> msgdma_1_mm_write_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                    // rsp_mux:src_valid -> msgdma_1_mm_write_agent:rp_valid
	wire  [363:0] rsp_mux_src_data;                                                     // rsp_mux:src_data -> msgdma_1_mm_write_agent:rp_data
	wire          rsp_mux_src_ready;                                                    // msgdma_1_mm_write_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                  // rsp_mux:src_channel -> msgdma_1_mm_write_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                            // rsp_mux:src_startofpacket -> msgdma_1_mm_write_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                              // rsp_mux:src_endofpacket -> msgdma_1_mm_write_agent:rp_endofpacket
	...
	wire  [364:0] hps_0_f2h_sdram1_data_agent_rf_source_data;                           // hps_0_f2h_sdram1_data_agent:rf_source_data -> hps_0_f2h_sdram1_data_agent_rsp_fifo:in_data
	...
	wire  [364:0] hps_0_f2h_sdram1_data_agent_rsp_fifo_out_data;                        // hps_0_f2h_sdram1_data_agent_rsp_fifo:out_data -> hps_0_f2h_sdram1_data_agent:rf_sink_data
	...
	wire  [363:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> hps_0_f2h_sdram1_data_agent:cp_data
	...
	wire          msgdma_1_mm_write_agent_cp_valid;                                     // msgdma_1_mm_write_agent:cp_valid -> router:sink_valid
	wire  [363:0] msgdma_1_mm_write_agent_cp_data;                                      // msgdma_1_mm_write_agent:cp_data -> router:sink_data
	wire          msgdma_1_mm_write_agent_cp_ready;                                     // router:sink_ready -> msgdma_1_mm_write_agent:cp_ready
	wire          msgdma_1_mm_write_agent_cp_startofpacket;                             // msgdma_1_mm_write_agent:cp_startofpacket -> router:sink_startofpacket
	wire          msgdma_1_mm_write_agent_cp_endofpacket;                               // msgdma_1_mm_write_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [363:0] hps_0_f2h_sdram1_data_agent_rp_data;                                  // hps_0_f2h_sdram1_data_agent:rp_data -> router_001:sink_data
	...
	wire  [257:0] hps_0_f2h_sdram1_data_agent_rdata_fifo_src_data;                      // hps_0_f2h_sdram1_data_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	...
	altera_merlin_master_translator #(
		...
		.reset                  (msgdma_1_reset_n_reset_bridge_in_reset_reset),                         //                     reset.reset
		...
		.av_burstcount          (msgdma_1_mm_write_burstcount),                                         //                          .burstcount
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                        //       clk.clk
		.reset                 (msgdma_1_reset_n_reset_bridge_in_reset_reset),                         // clk_reset.reset
