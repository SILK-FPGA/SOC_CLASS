...
proc compose { } {
    ...
    set_instance_parameter_value hps_0 {F2SDRAM_Width} {256 256}
    ...
    set_instance_parameter_value msgdma_0 {DATA_FIFO_DEPTH} {32}
    ...
    set_instance_parameter_value msgdma_0 {MAX_BYTE} {1048576}
    ...
    add_instance msgdma_1 altera_msgdma 20.1
    set_instance_parameter_value msgdma_1 {BURST_ENABLE} {1}
    set_instance_parameter_value msgdma_1 {BURST_WRAPPING_SUPPORT} {0}
    set_instance_parameter_value msgdma_1 {CHANNEL_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {CHANNEL_WIDTH} {8}
    set_instance_parameter_value msgdma_1 {DATA_FIFO_DEPTH} {32}
    set_instance_parameter_value msgdma_1 {DATA_WIDTH} {256}
    set_instance_parameter_value msgdma_1 {DESCRIPTOR_FIFO_DEPTH} {128}
    set_instance_parameter_value msgdma_1 {ENHANCED_FEATURES} {0}
    set_instance_parameter_value msgdma_1 {ERROR_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {ERROR_WIDTH} {8}
    set_instance_parameter_value msgdma_1 {EXPOSE_ST_PORT} {0}
    set_instance_parameter_value msgdma_1 {FIX_ADDRESS_WIDTH} {32}
    set_instance_parameter_value msgdma_1 {MAX_BURST_COUNT} {8}
    set_instance_parameter_value msgdma_1 {MAX_BYTE} {1048576}
    set_instance_parameter_value msgdma_1 {MAX_STRIDE} {1}
    set_instance_parameter_value msgdma_1 {MODE} {2}
    set_instance_parameter_value msgdma_1 {PACKET_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {PREFETCHER_DATA_WIDTH} {32}
    set_instance_parameter_value msgdma_1 {PREFETCHER_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {PREFETCHER_MAX_READ_BURST_COUNT} {2}
    set_instance_parameter_value msgdma_1 {PREFETCHER_READ_BURST_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {PROGRAMMABLE_BURST_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {RESPONSE_PORT} {2}
    set_instance_parameter_value msgdma_1 {STRIDE_ENABLE} {0}
    set_instance_parameter_value msgdma_1 {TRANSFER_TYPE} {Full Word Accesses Only}
    set_instance_parameter_value msgdma_1 {USE_FIX_ADDRESS_WIDTH} {0}

    add_instance sobel_soc_0 sobel_soc 1.0
    set_instance_parameter_value sobel_soc_0 {PARALLEL_PIXELS} {32}

    # connections and connection parameters
    add_connection clk_0.clk hps_0.f2h_sdram0_clock clock

    add_connection clk_0.clk hps_0.f2h_sdram1_clock clock

    add_connection clk_0.clk hps_0.h2f_lw_axi_clock clock

    add_connection clk_0.clk msgdma_0.clock clock

    add_connection clk_0.clk msgdma_1.clock clock

    add_connection clk_0.clk sobel_soc_0.clock clock

    add_connection clk_0.clk_reset msgdma_0.reset_n reset

    add_connection clk_0.clk_reset msgdma_1.reset_n reset

    add_connection clk_0.clk_reset sobel_soc_0.reset_sink reset

    add_connection hps_0.f2h_irq0 msgdma_0.csr_irq interrupt
    set_connection_parameter_value hps_0.f2h_irq0/msgdma_0.csr_irq irqNumber {0}

    add_connection hps_0.f2h_irq0 msgdma_1.csr_irq interrupt
    set_connection_parameter_value hps_0.f2h_irq0/msgdma_1.csr_irq irqNumber {1}

    add_connection hps_0.h2f_lw_axi_master msgdma_0.csr avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_0.csr arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_0.csr baseAddress {0x0020}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_0.csr defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master msgdma_0.descriptor_slave avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_0.descriptor_slave arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_0.descriptor_slave baseAddress {0x0050}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_0.descriptor_slave defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master msgdma_1.csr avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_1.csr arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_1.csr baseAddress {0x0000}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_1.csr defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master msgdma_1.descriptor_slave avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_1.descriptor_slave arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_1.descriptor_slave baseAddress {0x0040}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/msgdma_1.descriptor_slave defaultConnection {0}

    add_connection msgdma_0.mm_read hps_0.f2h_sdram0_data avalon
    ...
    add_connection msgdma_0.st_source sobel_soc_0.avalon_streaming_sink_0 avalon_streaming

    add_connection msgdma_1.mm_write hps_0.f2h_sdram1_data avalon
    set_connection_parameter_value msgdma_1.mm_write/hps_0.f2h_sdram1_data arbitrationPriority {1}
    set_connection_parameter_value msgdma_1.mm_write/hps_0.f2h_sdram1_data baseAddress {0x0000}
    set_connection_parameter_value msgdma_1.mm_write/hps_0.f2h_sdram1_data defaultConnection {0}

    add_connection sobel_soc_0.avalon_streaming_source_0 msgdma_1.st_sink avalon_streaming
