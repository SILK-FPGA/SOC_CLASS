...
proc compose { } {
    ...
    add_connection clk_0.clk bnn_avl_wrapper_0.clock clock
    ...
    add_connection clk_0.clk_reset bnn_avl_wrapper_0.reset_sink reset

    add_connection clk_0.clk_reset mm_bridge_0.reset reset

    add_connection clk_0.clk_reset msgdma_0.reset_n reset

    add_connection hps_0.f2h_irq1 msgdma_0.csr_irq interrupt
    ...
    add_connection mm_bridge_0.m0 bnn_avl_wrapper_0.avl_mm avalon
    ...
    add_connection msgdma_0.st_source bnn_avl_wrapper_0.avalon_streaming_sink avalon_streaming
