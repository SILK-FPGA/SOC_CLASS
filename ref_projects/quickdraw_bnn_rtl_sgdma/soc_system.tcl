...
add_instance bnn_avl_wrapper_0 bnn_avl_wrapper 1.0
...
add_instance hps_0 altera_hps 20.1
...
add_instance msgdma_0 altera_msgdma 20.1
...
set_instance_parameter_value msgdma_0 {DATA_FIFO_DEPTH} {64}
set_instance_parameter_value msgdma_0 {DATA_WIDTH} {32}
set_instance_parameter_value msgdma_0 {DESCRIPTOR_FIFO_DEPTH} {128}
...
set_instance_parameter_value msgdma_0 {MAX_BURST_COUNT} {8}
set_instance_parameter_value msgdma_0 {MAX_BYTE} {8192}
set_instance_parameter_value msgdma_0 {MAX_STRIDE} {1}
set_instance_parameter_value msgdma_0 {MODE} {1}
...
add_connection clk_0.clk bnn_avl_wrapper_0.clock
...
add_connection clk_0.clk msgdma_0.clock

add_connection clk_0.clk_reset bnn_avl_wrapper_0.reset_sink

add_connection clk_0.clk_reset mm_bridge_0.reset

add_connection clk_0.clk_reset msgdma_0.reset_n

add_connection hps_0.f2h_irq1 msgdma_0.csr_irq
set_connection_parameter_value hps_0.f2h_irq1/msgdma_0.csr_irq irqNumber {0}
...
add_connection mm_bridge_0.m0 bnn_avl_wrapper_0.avl_mm
set_connection_parameter_value mm_bridge_0.m0/bnn_avl_wrapper_0.avl_mm arbitrationPriority {1}
set_connection_parameter_value mm_bridge_0.m0/bnn_avl_wrapper_0.avl_mm baseAddress {0x0020}
set_connection_parameter_value mm_bridge_0.m0/bnn_avl_wrapper_0.avl_mm defaultConnection {0}

add_connection mm_bridge_0.m0 msgdma_0.csr
...
add_connection mm_bridge_0.m0 msgdma_0.descriptor_slave
set_connection_parameter_value mm_bridge_0.m0/msgdma_0.descriptor_slave arbitrationPriority {1}
set_connection_parameter_value mm_bridge_0.m0/msgdma_0.descriptor_slave baseAddress {0x0040}
set_connection_parameter_value mm_bridge_0.m0/msgdma_0.descriptor_slave defaultConnection {0}

add_connection msgdma_0.mm_read hps_0.f2h_sdram0_data
set_connection_parameter_value msgdma_0.mm_read/hps_0.f2h_sdram0_data arbitrationPriority {1}
set_connection_parameter_value msgdma_0.mm_read/hps_0.f2h_sdram0_data baseAddress {0x0000}
set_connection_parameter_value msgdma_0.mm_read/hps_0.f2h_sdram0_data defaultConnection {0}

add_connection msgdma_0.st_source bnn_avl_wrapper_0.avalon_streaming_sink
