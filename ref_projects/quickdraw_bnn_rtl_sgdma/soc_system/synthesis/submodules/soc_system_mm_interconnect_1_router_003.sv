...
module soc_system_mm_interconnect_1_router_003_default_decode
  ...
  (output [175 - 174 : 0] default_destination_id,
...
(
    ...
    localparam PKT_PROTECTION_H = 179;
    localparam PKT_PROTECTION_L = 177;
    localparam ST_DATA_W = 189;
