...
module soc_system_mm_interconnect_1 (
		...
		output wire [2:0]   bnn_avl_wrapper_0_avl_mm_address,              //                bnn_avl_wrapper_0_avl_mm.address
		output wire         bnn_avl_wrapper_0_avl_mm_write,                //                                        .write
		output wire         bnn_avl_wrapper_0_avl_mm_read,                 //                                        .read
		input  wire [31:0]  bnn_avl_wrapper_0_avl_mm_readdata,             //                                        .readdata
		output wire [31:0]  bnn_avl_wrapper_0_avl_mm_writedata,            //                                        .writedata
	...
	wire   [31:0] bnn_avl_wrapper_0_avl_mm_agent_m0_readdata;                        // bnn_avl_wrapper_0_avl_mm_translator:uav_readdata -> bnn_avl_wrapper_0_avl_mm_agent:m0_readdata
	wire          bnn_avl_wrapper_0_avl_mm_agent_m0_waitrequest;                     // bnn_avl_wrapper_0_avl_mm_translator:uav_waitrequest -> bnn_avl_wrapper_0_avl_mm_agent:m0_waitrequest
	wire          bnn_avl_wrapper_0_avl_mm_agent_m0_debugaccess;                     // bnn_avl_wrapper_0_avl_mm_agent:m0_debugaccess -> bnn_avl_wrapper_0_avl_mm_translator:uav_debugaccess
	wire    [6:0] bnn_avl_wrapper_0_avl_mm_agent_m0_address;                         // bnn_avl_wrapper_0_avl_mm_agent:m0_address -> bnn_avl_wrapper_0_avl_mm_translator:uav_address
	wire    [3:0] bnn_avl_wrapper_0_avl_mm_agent_m0_byteenable;                      // bnn_avl_wrapper_0_avl_mm_agent:m0_byteenable -> bnn_avl_wrapper_0_avl_mm_translator:uav_byteenable
	wire          bnn_avl_wrapper_0_avl_mm_agent_m0_read;                            // bnn_avl_wrapper_0_avl_mm_agent:m0_read -> bnn_avl_wrapper_0_avl_mm_translator:uav_read
	wire          bnn_avl_wrapper_0_avl_mm_agent_m0_readdatavalid;                   // bnn_avl_wrapper_0_avl_mm_translator:uav_readdatavalid -> bnn_avl_wrapper_0_avl_mm_agent:m0_readdatavalid
	wire          bnn_avl_wrapper_0_avl_mm_agent_m0_lock;                            // bnn_avl_wrapper_0_avl_mm_agent:m0_lock -> bnn_avl_wrapper_0_avl_mm_translator:uav_lock
	wire   [31:0] bnn_avl_wrapper_0_avl_mm_agent_m0_writedata;                       // bnn_avl_wrapper_0_avl_mm_agent:m0_writedata -> bnn_avl_wrapper_0_avl_mm_translator:uav_writedata
	wire          bnn_avl_wrapper_0_avl_mm_agent_m0_write;                           // bnn_avl_wrapper_0_avl_mm_agent:m0_write -> bnn_avl_wrapper_0_avl_mm_translator:uav_write
	wire    [2:0] bnn_avl_wrapper_0_avl_mm_agent_m0_burstcount;                      // bnn_avl_wrapper_0_avl_mm_agent:m0_burstcount -> bnn_avl_wrapper_0_avl_mm_translator:uav_burstcount
	wire          bnn_avl_wrapper_0_avl_mm_agent_rf_source_valid;                    // bnn_avl_wrapper_0_avl_mm_agent:rf_source_valid -> bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:in_valid
	wire   [81:0] bnn_avl_wrapper_0_avl_mm_agent_rf_source_data;                     // bnn_avl_wrapper_0_avl_mm_agent:rf_source_data -> bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:in_data
	wire          bnn_avl_wrapper_0_avl_mm_agent_rf_source_ready;                    // bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:in_ready -> bnn_avl_wrapper_0_avl_mm_agent:rf_source_ready
	wire          bnn_avl_wrapper_0_avl_mm_agent_rf_source_startofpacket;            // bnn_avl_wrapper_0_avl_mm_agent:rf_source_startofpacket -> bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:in_startofpacket
	wire          bnn_avl_wrapper_0_avl_mm_agent_rf_source_endofpacket;              // bnn_avl_wrapper_0_avl_mm_agent:rf_source_endofpacket -> bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:in_endofpacket
	wire          bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_valid;                 // bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:out_valid -> bnn_avl_wrapper_0_avl_mm_agent:rf_sink_valid
	wire   [81:0] bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_data;                  // bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:out_data -> bnn_avl_wrapper_0_avl_mm_agent:rf_sink_data
	wire          bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_ready;                 // bnn_avl_wrapper_0_avl_mm_agent:rf_sink_ready -> bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:out_ready
	wire          bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_startofpacket;         // bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:out_startofpacket -> bnn_avl_wrapper_0_avl_mm_agent:rf_sink_startofpacket
	wire          bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_endofpacket;           // bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo:out_endofpacket -> bnn_avl_wrapper_0_avl_mm_agent:rf_sink_endofpacket
	...
	wire    [6:0] msgdma_0_csr_agent_m0_address;                                     // msgdma_0_csr_agent:m0_address -> msgdma_0_csr_translator:uav_address
	...
	wire   [81:0] msgdma_0_csr_agent_rf_source_data;                                 // msgdma_0_csr_agent:rf_source_data -> msgdma_0_csr_agent_rsp_fifo:in_data
	...
	wire   [81:0] msgdma_0_csr_agent_rsp_fifo_out_data;                              // msgdma_0_csr_agent_rsp_fifo:out_data -> msgdma_0_csr_agent:rf_sink_data
	...
	wire    [6:0] msgdma_0_descriptor_slave_agent_m0_address;                        // msgdma_0_descriptor_slave_agent:m0_address -> msgdma_0_descriptor_slave_translator:uav_address
	...
	wire  [189:0] msgdma_0_descriptor_slave_agent_rf_source_data;                    // msgdma_0_descriptor_slave_agent:rf_source_data -> msgdma_0_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [189:0] msgdma_0_descriptor_slave_agent_rsp_fifo_out_data;                 // msgdma_0_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_0_descriptor_slave_agent:rf_sink_data
	...
	wire  [116:0] mm_bridge_0_m0_agent_cp_data;                                      // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire          bnn_avl_wrapper_0_avl_mm_agent_rp_valid;                           // bnn_avl_wrapper_0_avl_mm_agent:rp_valid -> router_001:sink_valid
	wire   [80:0] bnn_avl_wrapper_0_avl_mm_agent_rp_data;                            // bnn_avl_wrapper_0_avl_mm_agent:rp_data -> router_001:sink_data
	wire          bnn_avl_wrapper_0_avl_mm_agent_rp_ready;                           // router_001:sink_ready -> bnn_avl_wrapper_0_avl_mm_agent:rp_ready
	wire          bnn_avl_wrapper_0_avl_mm_agent_rp_startofpacket;                   // bnn_avl_wrapper_0_avl_mm_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          bnn_avl_wrapper_0_avl_mm_agent_rp_endofpacket;                     // bnn_avl_wrapper_0_avl_mm_agent:rp_endofpacket -> router_001:sink_endofpacket
	wire          msgdma_0_csr_agent_rp_valid;                                       // msgdma_0_csr_agent:rp_valid -> router_002:sink_valid
	wire   [80:0] msgdma_0_csr_agent_rp_data;                                        // msgdma_0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [188:0] msgdma_0_descriptor_slave_agent_rp_data;                           // msgdma_0_descriptor_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [116:0] router_src_data;                                                   // router:src_data -> mm_bridge_0_m0_limiter:cmd_sink_data
	...
	wire  [116:0] mm_bridge_0_m0_limiter_cmd_src_data;                               // mm_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [116:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [116:0] mm_bridge_0_m0_limiter_rsp_src_data;                               // mm_bridge_0_m0_limiter:rsp_src_data -> mm_bridge_0_m0_agent:rp_data
	...
	wire          bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_valid;              // bnn_avl_wrapper_0_avl_mm_burst_adapter:source0_valid -> bnn_avl_wrapper_0_avl_mm_agent:cp_valid
	wire   [80:0] bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_data;               // bnn_avl_wrapper_0_avl_mm_burst_adapter:source0_data -> bnn_avl_wrapper_0_avl_mm_agent:cp_data
	wire          bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_ready;              // bnn_avl_wrapper_0_avl_mm_agent:cp_ready -> bnn_avl_wrapper_0_avl_mm_burst_adapter:source0_ready
	wire    [2:0] bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_channel;            // bnn_avl_wrapper_0_avl_mm_burst_adapter:source0_channel -> bnn_avl_wrapper_0_avl_mm_agent:cp_channel
	wire          bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_startofpacket;      // bnn_avl_wrapper_0_avl_mm_burst_adapter:source0_startofpacket -> bnn_avl_wrapper_0_avl_mm_agent:cp_startofpacket
	wire          bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_endofpacket;        // bnn_avl_wrapper_0_avl_mm_burst_adapter:source0_endofpacket -> bnn_avl_wrapper_0_avl_mm_agent:cp_endofpacket
	wire          msgdma_0_csr_burst_adapter_source0_valid;                          // msgdma_0_csr_burst_adapter:source0_valid -> msgdma_0_csr_agent:cp_valid
	wire   [80:0] msgdma_0_csr_burst_adapter_source0_data;                           // msgdma_0_csr_burst_adapter:source0_data -> msgdma_0_csr_agent:cp_data
	...
	wire  [116:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> msgdma_0_descriptor_slave_cmd_width_adapter:in_data
	...
	wire  [188:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_data;              // msgdma_0_descriptor_slave_cmd_width_adapter:out_data -> msgdma_0_descriptor_slave_agent:cp_data
	...
	wire          router_001_src_valid;                                              // router_001:src_valid -> bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:in_valid
	wire   [80:0] router_001_src_data;                                               // router_001:src_data -> bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                              // bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [2:0] router_001_src_channel;                                            // router_001:src_channel -> bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                      // router_001:src_startofpacket -> bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                        // router_001:src_endofpacket -> bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:in_endofpacket
	wire          bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_valid;              // bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [116:0] bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_data;               // bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_ready;              // rsp_demux:sink_ready -> bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:out_ready
	wire    [2:0] bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_channel;            // bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_startofpacket;      // bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_endofpacket;        // bnn_avl_wrapper_0_avl_mm_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_002_src_valid;                                              // router_002:src_valid -> msgdma_0_csr_rsp_width_adapter:in_valid
	wire   [80:0] router_002_src_data;                                               // router_002:src_data -> msgdma_0_csr_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                              // msgdma_0_csr_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                            // router_002:src_channel -> msgdma_0_csr_rsp_width_adapter:in_channel
	...
	wire          msgdma_0_csr_rsp_width_adapter_src_valid;                          // msgdma_0_csr_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [116:0] msgdma_0_csr_rsp_width_adapter_src_data;                           // msgdma_0_csr_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          msgdma_0_csr_rsp_width_adapter_src_ready;                          // rsp_demux_001:sink_ready -> msgdma_0_csr_rsp_width_adapter:out_ready
	wire    [2:0] msgdma_0_csr_rsp_width_adapter_src_channel;                        // msgdma_0_csr_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          msgdma_0_csr_rsp_width_adapter_src_startofpacket;                  // msgdma_0_csr_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          msgdma_0_csr_rsp_width_adapter_src_endofpacket;                    // msgdma_0_csr_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          router_003_src_valid;                                              // router_003:src_valid -> msgdma_0_descriptor_slave_rsp_width_adapter:in_valid
	wire  [188:0] router_003_src_data;                                               // router_003:src_data -> msgdma_0_descriptor_slave_rsp_width_adapter:in_data
	...
	wire  [116:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_data;              // msgdma_0_descriptor_slave_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	wire          cmd_mux_src_valid;                                                 // cmd_mux:src_valid -> bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:in_valid
	wire  [116:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                 // bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                               // cmd_mux:src_channel -> bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                         // cmd_mux:src_startofpacket -> bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                           // cmd_mux:src_endofpacket -> bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:in_endofpacket
	wire          bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_valid;              // bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:out_valid -> bnn_avl_wrapper_0_avl_mm_burst_adapter:sink0_valid
	wire   [80:0] bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_data;               // bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:out_data -> bnn_avl_wrapper_0_avl_mm_burst_adapter:sink0_data
	wire          bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_ready;              // bnn_avl_wrapper_0_avl_mm_burst_adapter:sink0_ready -> bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:out_ready
	wire    [2:0] bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_channel;            // bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:out_channel -> bnn_avl_wrapper_0_avl_mm_burst_adapter:sink0_channel
	wire          bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_startofpacket;      // bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:out_startofpacket -> bnn_avl_wrapper_0_avl_mm_burst_adapter:sink0_startofpacket
	wire          bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_endofpacket;        // bnn_avl_wrapper_0_avl_mm_cmd_width_adapter:out_endofpacket -> bnn_avl_wrapper_0_avl_mm_burst_adapter:sink0_endofpacket
	wire          cmd_mux_001_src_valid;                                             // cmd_mux_001:src_valid -> msgdma_0_csr_cmd_width_adapter:in_valid
	wire  [116:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> msgdma_0_csr_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                             // msgdma_0_csr_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                           // cmd_mux_001:src_channel -> msgdma_0_csr_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                     // cmd_mux_001:src_startofpacket -> msgdma_0_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                       // cmd_mux_001:src_endofpacket -> msgdma_0_csr_cmd_width_adapter:in_endofpacket
	...
	wire   [80:0] msgdma_0_csr_cmd_width_adapter_src_data;                           // msgdma_0_csr_cmd_width_adapter:out_data -> msgdma_0_csr_burst_adapter:sink0_data
	...
	wire    [2:0] msgdma_0_csr_cmd_width_adapter_src_channel;                        // msgdma_0_csr_cmd_width_adapter:out_channel -> msgdma_0_csr_burst_adapter:sink0_channel
	...
	wire          bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_valid;               // bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_data;                // bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_ready;               // avalon_st_adapter:in_0_ready -> bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                     // avalon_st_adapter:out_0_valid -> bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                      // avalon_st_adapter:out_0_data -> bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                     // bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                     // avalon_st_adapter:out_0_error -> bnn_avl_wrapper_0_avl_mm_agent:rdata_fifo_sink_error
	...
	) bnn_avl_wrapper_0_avl_mm_translator (
		.clk                    (clk_0_clk_clk),                                   //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (bnn_avl_wrapper_0_avl_mm_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (bnn_avl_wrapper_0_avl_mm_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (bnn_avl_wrapper_0_avl_mm_agent_m0_read),          //                         .read
		.uav_write              (bnn_avl_wrapper_0_avl_mm_agent_m0_write),         //                         .write
		.uav_waitrequest        (bnn_avl_wrapper_0_avl_mm_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (bnn_avl_wrapper_0_avl_mm_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (bnn_avl_wrapper_0_avl_mm_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (bnn_avl_wrapper_0_avl_mm_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (bnn_avl_wrapper_0_avl_mm_agent_m0_writedata),     //                         .writedata
		.uav_lock               (bnn_avl_wrapper_0_avl_mm_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (bnn_avl_wrapper_0_avl_mm_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (bnn_avl_wrapper_0_avl_mm_address),                //      avalon_anti_slave_0.address
		.av_write               (bnn_avl_wrapper_0_avl_mm_write),                  //                         .write
		.av_read                (bnn_avl_wrapper_0_avl_mm_read),                   //                         .read
		.av_readdata            (bnn_avl_wrapper_0_avl_mm_readdata),               //                         .readdata
		.av_writedata           (bnn_avl_wrapper_0_avl_mm_writedata),              //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) bnn_avl_wrapper_0_avl_mm_agent (
		.clk                     (clk_0_clk_clk),                                                //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
		.m0_address              (bnn_avl_wrapper_0_avl_mm_agent_m0_address),                    //              m0.address
		.m0_burstcount           (bnn_avl_wrapper_0_avl_mm_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (bnn_avl_wrapper_0_avl_mm_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (bnn_avl_wrapper_0_avl_mm_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (bnn_avl_wrapper_0_avl_mm_agent_m0_lock),                       //                .lock
		.m0_readdata             (bnn_avl_wrapper_0_avl_mm_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (bnn_avl_wrapper_0_avl_mm_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (bnn_avl_wrapper_0_avl_mm_agent_m0_read),                       //                .read
		.m0_waitrequest          (bnn_avl_wrapper_0_avl_mm_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (bnn_avl_wrapper_0_avl_mm_agent_m0_writedata),                  //                .writedata
		.m0_write                (bnn_avl_wrapper_0_avl_mm_agent_m0_write),                      //                .write
		.rp_endofpacket          (bnn_avl_wrapper_0_avl_mm_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (bnn_avl_wrapper_0_avl_mm_agent_rp_ready),                      //                .ready
		.rp_valid                (bnn_avl_wrapper_0_avl_mm_agent_rp_valid),                      //                .valid
		.rp_data                 (bnn_avl_wrapper_0_avl_mm_agent_rp_data),                       //                .data
		.rp_startofpacket        (bnn_avl_wrapper_0_avl_mm_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (bnn_avl_wrapper_0_avl_mm_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (bnn_avl_wrapper_0_avl_mm_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (bnn_avl_wrapper_0_avl_mm_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (bnn_avl_wrapper_0_avl_mm_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (bnn_avl_wrapper_0_avl_mm_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                //                .error
		.rdata_fifo_src_ready    (bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_data),           //                .data
	...
	) bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                             //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (bnn_avl_wrapper_0_avl_mm_agent_rf_source_data),             //        in.data
		.in_valid          (bnn_avl_wrapper_0_avl_mm_agent_rf_source_valid),            //          .valid
		.in_ready          (bnn_avl_wrapper_0_avl_mm_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (bnn_avl_wrapper_0_avl_mm_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (bnn_avl_wrapper_0_avl_mm_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (bnn_avl_wrapper_0_avl_mm_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_merlin_slave_agent #(
		.PKT_ORI_BURST_SIZE_H      (188),
		.PKT_ORI_BURST_SIZE_L      (186),
		.PKT_RESPONSE_STATUS_H     (185),
		.PKT_RESPONSE_STATUS_L     (184),
		.PKT_BURST_SIZE_H          (165),
		.PKT_BURST_SIZE_L          (163),
		.PKT_TRANS_LOCK            (155),
		.PKT_BEGIN_BURST           (170),
		.PKT_PROTECTION_H          (179),
		.PKT_PROTECTION_L          (177),
		.PKT_BURSTWRAP_H           (162),
		.PKT_BURSTWRAP_L           (162),
		.PKT_BYTE_CNT_H            (161),
		.PKT_BYTE_CNT_L            (157),
	...
	soc_system_mm_interconnect_1_router_001 router_001 (
		.sink_ready         (bnn_avl_wrapper_0_avl_mm_agent_rp_ready),         //      sink.ready
		.sink_valid         (bnn_avl_wrapper_0_avl_mm_agent_rp_valid),         //          .valid
		.sink_data          (bnn_avl_wrapper_0_avl_mm_agent_rp_data),          //          .data
		.sink_startofpacket (bnn_avl_wrapper_0_avl_mm_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (bnn_avl_wrapper_0_avl_mm_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	) bnn_avl_wrapper_0_avl_mm_burst_adapter (
		.clk                   (clk_0_clk_clk),                                                //       cr0.clk
		.reset                 (mm_bridge_0_reset_reset_bridge_in_reset_reset),                // cr0_reset.reset
		.sink0_valid           (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_data),          //          .data
		.source0_channel       (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (bnn_avl_wrapper_0_avl_mm_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.sink_ready         (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.OUT_PKT_RESPONSE_STATUS_H     (185),
		.OUT_PKT_RESPONSE_STATUS_L     (184),
		.OUT_PKT_TRANS_EXCLUSIVE       (156),
		.OUT_PKT_BURST_TYPE_H          (167),
		.OUT_PKT_BURST_TYPE_L          (166),
		.OUT_PKT_ORI_BURST_SIZE_L      (186),
		.OUT_PKT_ORI_BURST_SIZE_H      (188),
		.OUT_ST_DATA_W                 (189),
		.ST_CHANNEL_W                  (3),
		.OPTIMIZE_FOR_RSP              (0),
		.RESPONSE_PATH                 (0),
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) bnn_avl_wrapper_0_avl_mm_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                //       clk.clk
		.reset                (mm_bridge_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		...
		.out_endofpacket      (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_data),          //          .data
		.out_channel          (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (bnn_avl_wrapper_0_avl_mm_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                        // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.IN_PKT_RESPONSE_STATUS_H      (185),
		.IN_PKT_RESPONSE_STATUS_L      (184),
		.IN_PKT_TRANS_EXCLUSIVE        (156),
		.IN_PKT_BURST_TYPE_H           (167),
		.IN_PKT_BURST_TYPE_L           (166),
		.IN_PKT_ORI_BURST_SIZE_L       (186),
		.IN_PKT_ORI_BURST_SIZE_H       (188),
		.IN_ST_DATA_W                  (189),
		.OUT_PKT_ADDR_H                (78),
		.OUT_PKT_ADDR_L                (72),
		.OUT_PKT_DATA_H                (63),
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) bnn_avl_wrapper_0_avl_mm_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                //       clk.clk
		.reset                (mm_bridge_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		...
		.out_endofpacket      (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_data),          //          .data
		.out_channel          (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (bnn_avl_wrapper_0_avl_mm_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                        // (terminated)
	);
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_0_data      (bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (bnn_avl_wrapper_0_avl_mm_agent_rdata_fifo_src_ready), //         .ready
