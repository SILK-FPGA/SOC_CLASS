module buffer_AI (
    ...
    // =====================================================
    logic [FRAME_BITS-1:0] frame_bits; //thanh ghi de chua du 1024 bit 
    ...
    always_ff @(posedge avl_clk_i) begin
        if (!rstn_i) begin
            ...
            if (avl_reset_rise) begin
                ...
                if (avl_enable_i) begin // avl_enable_i giong nhu la avl_data_valid 
            ...
            // Ghi cac beat con lai.
                ...
                if (avl_count == 3'd3) begin
                    avl_done_o <= 1'b1; // khi avl_count = 3 nghia la da nhan duoc 4 lan data tu ram (4*256 bit = 1024 bit) va avl_done_o = 1 nghia la da nhan duoc toan bo frame
                end else begin
