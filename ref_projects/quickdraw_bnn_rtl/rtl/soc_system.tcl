...
add_instance pio_1 altera_avalon_pio 20.1
...
add_instance read_avalon_sdr_0 read_avalon_sdr 1.0

# exported interfaces
add_interface ai_result_i conduit end
set_interface_property ai_result_i EXPORT_OF pio_1.external_connection
add_interface clk clock sink
set_interface_property clk EXPORT_OF clk_0.clk_in
add_interface ext_connect_o conduit end
set_interface_property ext_connect_o EXPORT_OF pio_0.external_connection
...
add_interface read_data_o conduit end
set_interface_property read_data_o EXPORT_OF read_avalon_sdr_0.read_data
add_interface read_done_o conduit end
set_interface_property read_done_o EXPORT_OF read_avalon_sdr_0.read_done
add_interface read_enable_o conduit end
set_interface_property read_enable_o EXPORT_OF read_avalon_sdr_0.read_enable
add_interface read_reset_o conduit end
set_interface_property read_reset_o EXPORT_OF read_avalon_sdr_0.read_reset
add_interface read_start_i conduit end
set_interface_property read_start_i EXPORT_OF read_avalon_sdr_0.start
...
add_connection clk_0.clk read_avalon_sdr_0.clock

add_connection clk_0.clk_reset pio_0.reset

add_connection clk_0.clk_reset pio_1.reset

add_connection clk_0.clk_reset read_avalon_sdr_0.reset

add_connection hps_0.h2f_axi_master pio_0.s1
set_connection_parameter_value hps_0.h2f_axi_master/pio_0.s1 arbitrationPriority {1}
set_connection_parameter_value hps_0.h2f_axi_master/pio_0.s1 baseAddress {0x0000}
set_connection_parameter_value hps_0.h2f_axi_master/pio_0.s1 defaultConnection {0}

add_connection hps_0.h2f_axi_master pio_1.s1
set_connection_parameter_value hps_0.h2f_axi_master/pio_1.s1 arbitrationPriority {1}
set_connection_parameter_value hps_0.h2f_axi_master/pio_1.s1 baseAddress {0x0010}
set_connection_parameter_value hps_0.h2f_axi_master/pio_1.s1 defaultConnection {0}

add_connection read_avalon_sdr_0.m0 hps_0.f2h_sdram0_data
set_connection_parameter_value read_avalon_sdr_0.m0/hps_0.f2h_sdram0_data arbitrationPriority {1}
set_connection_parameter_value read_avalon_sdr_0.m0/hps_0.f2h_sdram0_data baseAddress {0x0000}
set_connection_parameter_value read_avalon_sdr_0.m0/hps_0.f2h_sdram0_data defaultConnection {0}
